...
-- Table `idea`.`pessoa`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `idea`.`pessoa` ;
...
CREATE TABLE IF NOT EXISTS `idea`.`pessoa` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `AA_email_UNIQUE` (`email` ASC))
ENGINE = InnoDB;
...
-- Table `idea`.`terceiro`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `idea`.`terceiro` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `idea`.`pessoa_terceiro` ;
...
CREATE TABLE IF NOT EXISTS `idea`.`pessoa_terceiro` (
  ...
  INDEX `fk_pessoa_terceiro_pessoa1_idx` (`pessoa_id` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `idea`.`privilegio` ;
...
-- -----------------------------------------------------
-- Table `idea`.`pessoa_privilegio`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `idea`.`pessoa_privilegio` ;

CREATE TABLE IF NOT EXISTS `idea`.`pessoa_privilegio` (
  `pessoa_id` INT NOT NULL,
  `privilegio_id` INT NOT NULL,
  PRIMARY KEY (`pessoa_id`, `privilegio_id`),
  INDEX `fk_pessoa_privilegio_privilegio1_idx` (`privilegio_id` ASC),
  CONSTRAINT `fk_pessoa_privilegio_pessoa1`
    FOREIGN KEY (`pessoa_id`)
    REFERENCES `idea`.`pessoa` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pessoa_privilegio_privilegio1`
...
INSERT INTO `idea`.`privilegio` (`nome`) VALUES ('administrador');
